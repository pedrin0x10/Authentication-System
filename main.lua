...
-- CONFIG -----------------------------------------------------------
local api = "http://api.pedrin.xyz:8080" -- IP DA API CASO VA USAR UMA PORTA DIFERENTE DA 80 COLOQUE IP:PORTA OU DOMINIO.COM:PORTA ex: 1.1.1.1:5454 ou gooogle.com:5454
